...
# Import dalle librerie specifiche
from skimage.transform import rotate, resize
from skimage import morphology
from scipy.spatial import ConvexHull
from sklearn.cluster import KMeans
from skimage.color import rgb2hsv
from scipy.stats import circmean, circvar, entropy # Aggiunto entropy qui
...
IMAGE_FOLDER = 'imgs'
MASK_FOLDER = 'masks'
OUTPUT_FILE = 'extracted_features_2.csv'
RESIZE_DIM = 512  
...
def convexity_score(mask):
    ...
    return np.count_nonzero(mask) / hull.volume
...
def get_hsv_features(image, mask):
    segments = slic(image, n_segments=6, compactness=0.1, mask=mask, start_label=1, channel_axis=2)
    hsv = rgb2hsv(image)
...
def process_file(filepath):
    try:
        ...
        h_entropy = get_hue_entropy(img, mask) # Calcolo Entropia
        ...
        return {
            ...
            "Hue_Entropy": h_entropy # Aggiunto al CSV
        }
